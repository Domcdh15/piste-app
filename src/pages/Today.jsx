    ...
    <div>
      <div className="hero-band" style={{ color: "var(--text)", padding: "40px 40px 32px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: "16px" }}>
          ...
          <button className="focusable" onClick={openOrganize} style={{ display: "flex", alignItems: "center", gap: "7px", background: "var(--panel2)", border: "0.5px solid var(--hairline)", borderRadius: "8px", padding: "9px 16px", color: "var(--text)", fontSize: "14px", fontWeight: 600 }}>
            <SparklesIcon size={14} color="var(--blue)" /> Organiser ma journée
          </button>
        </div>

        {totalWithDone > 0 && (
          <div style={{ marginTop: "18px" }}>
            <div style={{ height: "3px", width: "260px", background: "var(--hairline)", borderRadius: "2px", overflow: "hidden" }}>
