...
function DaySummaryBar({ overdueCount, todayCount, onOrganize, organizing }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: "16px", flexWrap: "wrap", background: "var(--panel)", border: "0.5px solid var(--hairline)", borderRadius: "10px", padding: "12px 16px", marginBottom: "16px" }}>
      ...
      <button className="focusable" onClick={onOrganize} style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: "6px", background: organizing ? "var(--blue)" : "var(--blue-dim)", color: organizing ? "#fff" : "var(--blue)", border: "0.5px solid #2a3ed655", borderRadius: "8px", padding: "8px 14px", fontSize: "12.5px", fontWeight: 600 }}>
  ...
  return (
    <form onSubmit={submit} style={{ background: "var(--panel)", border: "0.5px solid var(--hairline)", borderRadius: "12px", boxShadow: "var(--shadow-sm)", padding: "16px", marginBottom: "18px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px" }}>
      ...
      <div style={{ gridColumn: "1 / -1", display: "flex", gap: "8px" }}>
        <button type="submit" disabled={saving || !prospectId || !note.trim()} className="focusable" style={{ flex: 1, background: "var(--blue-dim)", color: "var(--blue)", border: "0.5px solid #2a3ed655", borderRadius: "8px", padding: "9px", fontSize: "13px", fontWeight: 600 }}>
...
${list || "Aucune."}`;
  ...
  return (
    <div style={{ background: "var(--blue-dim)", border: "0.5px solid #2a3ed655", borderRadius: "12px", padding: "16px", marginBottom: "18px" }}>
