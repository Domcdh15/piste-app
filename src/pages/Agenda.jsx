                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        border: "0.5px solid #4c9ad455", borderRadius: "6px", padding: "4px 6px",
      ...
      {!prospect ? (
        ...
        <>
          <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "14px", paddingBottom: "14px", borderBottom: "0.5px solid var(--hairline)" }}>
            ...
            <button className="focusable" onClick={() => onOpenProspect?.(prospect.id)} style={{ marginLeft: "auto", fontSize: "11px", padding: "5px 9px", borderRadius: "6px", background: "var(--blue-dim)", color: "var(--blue)", border: "0.5px solid #4c9ad455" }}>
              Ouvrir le dossier
            </button>
          </div>
          ...
          <button className="focusable" onClick={generatePrep} disabled={loadingPrep} style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", width: "100%", background: "var(--blue-dim)", color: "var(--blue)", border: "0.5px solid #4c9ad455", borderRadius: "8px", padding: "9px", fontSize: "13px", marginBottom: "12px", opacity: loadingPrep ? 0.6 : 1 }}>
...
function DaySummaryBar({ overdueCount, todayCount, onOrganize, organizing }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: "16px", flexWrap: "wrap", background: "var(--panel)", border: "0.5px solid var(--hairline)", borderRadius: "10px", padding: "12px 16px", marginBottom: "16px" }}>
      ...
      <button className="focusable" onClick={onOrganize} style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: "6px", background: organizing ? "var(--blue)" : "var(--blue-dim)", color: organizing ? "#fff" : "var(--blue)", border: "0.5px solid #4c9ad455", borderRadius: "8px", padding: "8px 14px", fontSize: "12.5px", fontWeight: 600 }}>
  ...
  return (
    <form onSubmit={submit} style={{ background: "var(--panel)", border: "0.5px solid var(--hairline)", borderRadius: "12px", boxShadow: "var(--shadow-sm)", padding: "16px", marginBottom: "18px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px" }}>
      ...
      <div style={{ gridColumn: "1 / -1", display: "flex", gap: "8px" }}>
        <button type="submit" disabled={saving || !prospectId || !note.trim()} className="focusable" style={{ flex: 1, background: "var(--blue-dim)", color: "var(--blue)", border: "0.5px solid #4c9ad455", borderRadius: "8px", padding: "9px", fontSize: "13px", fontWeight: 600 }}>
...
${list || "Aucune."}`;
  ...
  return (
    <div style={{ background: "var(--blue-dim)", border: "0.5px solid #4c9ad455", borderRadius: "12px", padding: "16px", marginBottom: "18px" }}>
