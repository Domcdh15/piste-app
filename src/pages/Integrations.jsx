    ...
    <div style={{ padding: "28px 32px 60px", maxWidth: "820px" }}>
      ...
      <div style={{ marginBottom: "32px" }}>
        ...
        {!loading && connectedTools.length === 0 ? (
          <div style={{ background: "var(--panel)", border: "0.5px solid var(--hairline)", borderRadius: "12px", padding: "24px", textAlign: "center" }}>
            ...
            <button className="focusable" onClick={() => document.getElementById("connect-app-anchor")?.scrollIntoView({ behavior: "smooth" })} style={{ background: "var(--blue-dim)", color: "var(--blue)", border: "0.5px solid #2a3ed655", borderRadius: "8px", padding: "8px 16px", fontSize: "13px", fontWeight: 600 }}>
      ...
      <div id="connect-app-anchor" style={{ marginBottom: "8px" }}>
        ...
        <div style={{ display: "flex", gap: "6px", flexWrap: "wrap", marginBottom: "20px" }}>
          {CATEGORIES.map((c) => (
            <button key={c} className="focusable" onClick={() => setCategory(c)} style={{ padding: "6px 12px", borderRadius: "999px", fontSize: "12px", fontWeight: 500, background: category === c ? "var(--blue-dim)" : "var(--panel2)", color: category === c ? "var(--blue)" : "var(--text-dim)", border: category === c ? "0.5px solid #2a3ed655" : "0.5px solid var(--hairline)" }}>
              {c}
            </button>
          ))}
        </div>
      ...
      <div style={{ background: "var(--panel)", border: "0.5px solid var(--hairline)", borderRadius: "12px", padding: "18px", textAlign: "center" }}>
        ...
        <a href="mailto:support@clos-ia.fr" className="focusable" style={{ display: "inline-block", background: "var(--blue-dim)", color: "var(--blue)", border: "0.5px solid #2a3ed655", borderRadius: "8px", padding: "8px 16px", fontSize: "13px", fontWeight: 600, textDecoration: "none" }}>
    ...
    <div style={{ background: "var(--panel)", border: "0.5px solid var(--hairline)", borderRadius: "10px", padding: "14px", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "8px" }}>
        ...
        {!tool.real ? (
          ...
          <button className="focusable" onClick={onConnect} style={{ fontSize: "11.5px", padding: "6px 10px", borderRadius: "6px", background: "var(--blue-dim)", color: "var(--blue)", border: "0.5px solid #2a3ed655", whiteSpace: "nowrap" }}>
            Connecter
          </button>
        )}
      </div>
